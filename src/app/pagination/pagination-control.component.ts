...
import {PaginationService, IPaginationInstance} from './paginate.service';
import {DEFAULT_TEMPLATE, DEFAULT_STYLES} from './paginate-template';
...
export class PaginationControlsComponent implements OnInit, OnChanges, AfterViewInit, OnDestroy {
